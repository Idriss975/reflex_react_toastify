"""Reflex custom component ReactToastify."""
...
# class ReactToastify(NoSSRComponent):
#     pass


class ReactToastify(rx.Component):
    """ReactToastify component."""

    # The React library to wrap.
    library = "react-toastify"

    # The React component tag.
    tag = "{ ToastContainer, toast }"
...
react_toastify = ReactToastify.create